#ifndef DISTANCES_LSX_H
#define DISTANCES_LSX_H
...
void
fvec_inner_product_batch_4_lsx_bf16_patch(const float* x, const float* y0, const float* y1, const float* y2,
