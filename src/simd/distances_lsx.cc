...
float
fvec_L2sqr_lsx_bf16_patch(const float* x, const float* y, size_t d) {
    size_t i;
    float res = 0;
    for (i = 0; i < d; i++) {
...
float
fvec_inner_product_lsx_bf16_patch(const float* x, const float* y, size_t d) {
    size_t i;
    float res = 0;
    for (i = 0; i < d; i++) {
...
void
fvec_inner_product_batch_4_lsx_bf16_patch(const float* __restrict x, const float* __restrict y0,
...
void
fvec_L2sqr_batch_4_lsx_bf16_patch(const float* x, const float* y0, const float* y1, const float* y2, const float* y3,
                                  const size_t d, float& dis0, float& dis1, float& dis2, float& dis3) {
    float d0 = 0;
    float d1 = 0;
    float d2 = 0;
